...
var script = defineComponent({
  ...
  props: tooltipProps,
  setup(__props) {
    const bem2 = createNameSpace("tooltip");
    const props = __props;
    const reference = ref();
    const floating = ref();
    const arrowRef = ref();
    ...
    const handleClick = (e) => {
      ...
      if (reference.value && e.target) {
        if (!((_a = reference.value) == null ? void 0 : _a.contains(e.target))) {
          hide();
        }
      }
    };
          ...
          createVNode(Transition, { persisted: "" }, {
            default: withCtx(() => [
              withDirectives(createBaseVNode(
                "div",
                mergeProps({
                  class: [unref(bem2).e("content"), unref(bem2).m(_ctx.effect)],
                  ref_key: "floating",
                  ref: floating
                ...
                [
                  ...
                  createBaseVNode(
                    "div",
                    {
                      ref_key: "arrowRef",
                      ref: arrowRef,
                      class: normalizeClass([unref(bem2).e("arrow"), unref(bem2).m(`${_ctx.effect}-arrow`)])
                    },
                    null,
                    2
                    /* CLASS */
...
script.__scopeId = "data-v-694d1617";
script.__file = "packages/components/tooltip/src/tooltip.vue";
var Tooltip = withInstall(script);
export {
  Tooltip,
  Tooltip as default,
  tooltipProps,
...
//# sourceMappingURL=horse-ui_es_components_tooltip_index__js.js.map
