...
import type { DocSearchProps } from 'vitepress/types/docsearch.js'
import type {
  LocalSearchTranslations,
  PageSplitSection
} from 'vitepress/types/local-search.js'
import type { Awaitable, MarkdownEnv, PageData } from 'vitepress/types/shared.js'
