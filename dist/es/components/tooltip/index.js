          ...
          createVNode(Transition, { persisted: "" }, {
            default: withCtx(() => [
              withDirectives(createElementVNode(
                "div",
                mergeProps({
                  class: [unref$1(bem).e("content"), unref$1(bem).m(_ctx.effect)],
                  ref_key: "floating",
                  ref: floating
                ...
                [
                  ...
                  createElementVNode(
                    "div",
                    {
                      ref_key: "arrowRef",
                      ref: arrowRef,
                      class: normalizeClass([unref$1(bem).e("arrow"), unref$1(bem).m(`${_ctx.effect}-arrow`)])
                    },
                    null,
                    2
                    /* CLASS */
...
const Tooltip = withInstall(script);

export { Tooltip, Tooltip as default, tooltipProps, triggerTypes };
